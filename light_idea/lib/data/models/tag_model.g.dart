...
extension TagModelByIndex on IsarCollection<TagModel> {
  ...
  TagModel? getByNameSync(String name) {
  ...
  Future<List<TagModel?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<TagModel?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(TagModel object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(TagModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<TagModel> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<TagModel> objects, {bool saveLinks = true}) {
