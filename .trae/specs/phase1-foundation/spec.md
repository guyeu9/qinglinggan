...
根据《轻灵感开发设计文档_新方案版.md》，需要搭建项目的基础架构，实现数据库初始化和记录功能的核心业务逻辑，为后续 AI 功能和前端页面开发奠定基础。

## What Changes

- 创建 Flutter 项目并配置依赖
- 实现 Domain 层（业务实体和仓库接口）
- 实现 Data 层（Isar 数据模型和仓库实现）
- 实现 Application 层（业务用例）
- 实现 Core 层（工具类和常量）
- 编写单元测试验证核心功能

## Impact

- Affected specs: 项目基础架构
- Affected code: 
